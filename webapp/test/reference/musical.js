// THE ORACLE. This is lib/viz/musical.js as it was in JavaScript, before the
// musical reading moved to Rust (webapp/rhythm/src/viz_motion.rs). It is kept,
// unchanged but for its imports, for one job: test/vizcore.test.mjs feeds it
// and the Rust reading the same analysis and holds every field to the same
// value, frame by frame. It is not imported by the app.
...
import { approach, clamp, envelope } from "../../src/lib/viz/util.js";
